...
| `build` | Push to main | Validates, compiles `flags.json`, updates the README table, commits + pushes if anything changed. |

## README markers

In build mode, the action replaces content between two HTML-comment markers:
